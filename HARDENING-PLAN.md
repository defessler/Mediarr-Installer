...
- **Sprint 4 (resilience + ops):** ✅ **v0.5.0** — #15 confidence/dmidecode + #16 resumability/retries + #17 deeper pre-flight (adversarially reviewed; 5 confirmed defects fixed: stale-ENV_FILE-after-migration, Python-hash quote injection, classify.sh parity, summary LAN_IP, frozen-hash-vs-NordVPN). #19 CI harness already landed in Sprint 2. ⏳ Remaining for **v0.5.1**: #20 diagnostics bundle, #18 Podman (stretch).
