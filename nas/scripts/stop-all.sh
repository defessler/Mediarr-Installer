...
PROFILES=(plex jellyfin sonarr radarr lidarr bazarr usenet torrenting vpn soulseek playlists livetv komga kavita homepage recyclarr unpackerr flaresolverr)
...
for c in prowlarr flaresolverr plex jellyfin tautulli seerr sonarr radarr lidarr \
         ...
         komga kavita homepage recyclarr unpackerr; do
