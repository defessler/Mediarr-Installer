...
SERVICE_DIRS="plex jellyfin tautulli seerr prowlarr sonarr radarr lidarr bazarr qbittorrent sabnzbd recyclarr unpackerr homepage librarian slskd soularr playlistsync dispatcharr komga kavita mylar3 lazylibrarian audiobookshelf"

# The stack's fixed container_names. gluetun LAST (its namespace-sharers must be
# removed first, or Docker refuses to rm it).
STACK_CONTAINERS="plex jellyfin tautulli seerr prowlarr sonarr radarr lidarr bazarr qbittorrent sabnzbd recyclarr recyclarr-trigger unpackerr flaresolverr homepage librarian slskd soularr playlistsync dispatcharr komga kavita mylar3 lazylibrarian audiobookshelf gluetun"
