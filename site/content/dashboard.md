...
- The tile colour tells you at a glance whether the service is **up** (green) or unreachable.
...
- **Start here every time.** Every guide in this wiki tells you to open a service — find it on Homepage instead of remembering port numbers.
...
- **A grey tile usually means the service is still starting up**, not broken — especially right after an install or NAS reboot. Give it a minute and refresh.
