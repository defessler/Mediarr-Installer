...
description: "Turn your library into stations and mixtapes with Plexamp."
lede: "Turn your library into stations and mixtapes with Plexamp."
group: "Music"
order: 4
---
...
> [Music downloads with Soulseek](Music-Setup).

> Want live radio rather than your own library? Music Assistant is the usual
> pick for that, run separately from this stack. Mediarr shipped an AzuraCast
> broadcast option once and removed it in v0.18.0.
...
- **A regular playlist.** Find a song, album, or artist, tap the **`...`**
  ...
  or create a new one. Add as much as you like, and reorder it however you want. It
...
2. **Sonic Analysis isn't switched on for the library.** The installer turns it
   ...
   one-time toggle, so follow the steps below.
...
4. Find the dropdown labeled **"Analyze audio tracks for sonic features"** (Plex
   Pass only, and only on supported x86-64 CPUs).
...
| Item | Value |
|---|---|
| Player app | **Plexamp** on iOS, Android, desktop, or web at `https://plexamp.plex.tv` |
