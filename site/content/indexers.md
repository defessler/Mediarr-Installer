...
Think of an indexer as a catalogue. When Radarr wants a movie, it asks the indexer
...
once in Prowlarr and it syncs automatically to Sonarr, Radarr, and Lidarr — no
...
- **Quality profile affects what gets grabbed.** If an indexer returns results but nothing
  downloads, check your [Quality Profiles](Quality-Profiles) — the release may not meet
