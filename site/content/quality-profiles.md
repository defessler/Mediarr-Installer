...
|---|---|
| `web-1080p` | Default — 1080p streaming releases (WEB); Bluray sources are scored highest within this profile |
| `web-2160p` | 4K WEB (HDR / Dolby Vision scored) |
| `bluray-1080p` | Alias for `web-1080p` — TRaSH has no separate Sonarr Bluray recipe; WEB-1080p already scores Bluray sources highest |
...
- Enough free disk space (Remux files can be 50–80 GB per movie)
- A Plex or Jellyfin client that can play 4K (and ideally direct-play it — transcoding 4K is CPU-heavy)
