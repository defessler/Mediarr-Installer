...
> **In one sentence:** open the request portal, search a title, click Request, and
> a while later it's in Plex/Jellyfin, ready to play. You never touch Sonarr or
> Radarr directly.

> Using Jellyfin instead of Plex? Everything below is identical, and your portal is
...
stack. It shows a browsable, searchable catalog of movies and shows. When
...
4. When it flips to **Available**, it's in Plex/Jellyfin, so just play it.
...
- **Notifications:** Settings → Notifications wires up Discord, Telegram, email,
  etc., so you get pinged when a request becomes available.
- **Already in your library?** Seerr grays out the Request button and shows
